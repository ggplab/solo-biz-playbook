...
| "내 사업을 한 장으로 정리하는 법" | [`examples/README.md`](../examples/) | 사례와 이미지가 먼저 보여야 할 때 |
...
| "Claude Max 월간 사용 복기" | [`examples/monthly-claude-review/README.md`](../examples/monthly-claude-review/) | 정량 리뷰 워크플로와 예시 보고서를 바로 보여줄 때 |
